<div class="app-content-header" style="background: white; color: black; padding: 2rem 0; margin: -20px -20px 2rem -20px; border-radius: 0;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-3" style="color: black;">Dashboard Admin</h3>
                <p class="text-muted mb-0" style="color: black;">Ringkasan data dan statistik sistem</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <a href="/admin/calon-klien?t=add" class="text-decoration-none">
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="/admin/klien?t=add" class="text-decoration-none">
                                    <div class="d-flex align-items-center p-3 rounded border">
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="/admin/modul?t=add" class="text-decoration-none">
                                    <div class="d-flex align-items-center p-3 rounded border">
                                        <i class="bi bi-collection-fill text-info me-3 fs-4"></i>
                                        <div>
                                            <h6 class="mb-1">Tambah Modul</h6>
                                            <small class="text-muted">Input modul baru</small>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="/admin/master-akun?t=add" class="text-decoration-none">
                                    <div class="d-flex align-items-center p-3 rounded border">
                                        <i class="bi bi-person-badge-fill text-warning me-3 fs-4"></i>
                                        <div>
                                            <h6 class="mb-1">Tambah User</h6>
                                            <small class="text-muted">Input user baru</small>
                                        </div>
                                    </div>
                                </a>
                            </div>
