                ...
                <div class="card mb-4" style="box-shadow:none;">
                    <div class="p-3 d-flex justify-content-between align-items-center" style="border-bottom:1px solid gainsboro;">
                        ...
                        <div class="d-flex gap-2">
                            <a href="/pengguna/klien/export">
                                <button class="btn btn-success btn-sm" style="background:#28a745;border-color:#28a745;">
                                    <i class="bi bi-file-earmark-excel"></i> Export Excel
                                </button>
                            </a>
                            <a href="/pengguna/klien?t=add">
                                <button class="btn btn-primary btn-sm" style="background:#30645b;border-color:#30645b;"><i class="bi bi-plus"></i> Klien Baru</button>
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="myTable" class="display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="/pengguna/klien?t=edit&id=<?= $item['id'] ?>">
                                                <button class="btn btn-primary btn-sm">
                                                    <i class="bi bi-pen"></i>
                                                </button>
                                            </a>
                                            <a href="/pengguna/klien?t=delete&id=<?= $item['id'] ?>">
